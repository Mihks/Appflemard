		...
		<section>
			<article>
				...
				<div id="a_propos">
					...
					<img src="agence/images/flemardga.jpg" id="imaga" width="200" height="200" border="1" title="Flemard" alt="Flemard"  /><sub style="font-family: chiller;color: red;">Flemard</sub>
