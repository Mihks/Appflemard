...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            $.post('qrc_id.php',{"id":res.code},function(data){

                $('#checkmatch').html(data);

                window['voir_scan'] = data;
                
                $('#checkmatch').dialog({modal:true,width:600,title:'Résultat du scan ' + res.format +' : ' + res.code,buttons:{
